...
| [`codex/`](../hooks/codex/README.md) | OpenAI Codex CLI | Awareness document, AGENTS.md integration, optional Docker MCP assets |
...
| Codex CLI | Awareness doc or optional Docker MCP tool | AGENTS.md integration, optional explicit rewrite tool | Yes via MCP; otherwise N/A (prompt) |
